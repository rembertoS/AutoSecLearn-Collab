# Brainstorming - 6 App Ideas
## *Potential Ideas*
1. **AutoSecLearn** - Learning platform for IT professionals to gain more skills in automated network configurations (routers, switches, Python code, etc.).
2. **CodeDrill** - A coding practice app where the user solves daily Swift challenges and tracks their progress.
3. **FitnessTracker** - Allows users to keep track of their fitness journey by logging their food, exercises, and the weight they are using.
4. **GoalKeeper** - Aids users with reaching their goals by allowing them to list their goals and would be held accountable for the app. The app would send push notifications and even have a set reward system when a user hits certain goals, is consistent, etc.
5. **Daily Planner** - A “virtual assistant” for people with busy lifestyles. It allows users to plan their day, manage their calendar, and even set reminders to help them to stay on task.
...
3. **Flappy Bird**
   ...
   - Habit: This was a highly addictive game in the past so it does have potential to be played everyday but in reality, it is a fad so it may be really popular at some point but then die out.
   - Scope: This app can realistically be developed in one semester but may be difficult.

___

   ***We chose AutoSec Learn because it fits our goals of cresting a learning platform while also creating a game-like feel. It combines the organization of the Daily Planner while keeping the fun and entertainment from Flappy Bird.*** 
